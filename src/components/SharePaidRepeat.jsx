...
const SharePaidRepeat = () => {
  ...
  return (
    <motion.section className=" text-white  relative">
      <motion.div className="max-w-[1620px] w-[90%] mx-auto ">
        <motion.h2 className="text-5xl font-medium text-center max-md:text-4xl w-full max-w-[850px] leading-[1.2]
      ...
      bg-sec-radial backdrop-blur-[25px] border-2 border-[#B6D3FF] border-opacity-10 bg-no-repeat max-2xl:px-[3%]"
        >
          ...
          >
            <motion.h4 className="text-[31px] font-medium  mb-[66px] max-xl:mb-11 max-lg:mb-9 max-md:mb-6 max-2xl:text-[28px] max-xl:text-2xl max-lg:text-xl">
              Tier 1
            </motion.h4>
