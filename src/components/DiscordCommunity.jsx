...
export default function DiscordCommunity() {
  return (
    <div 
      className="max-w-full w-[1230px] mx-auto flex flex-col items-center justify-center text-white rounded-[32px] border-2 border-[#B6FFB9] border-opacity-5 py-24 p-10 max-md:px-5 bg-[rgba(11,172,118,0.06)]"
      style={{ backgroundImage: `url(${DiscordBgImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
