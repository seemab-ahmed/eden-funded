        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {statsData.map(
            ({ id, end, prefix, suffix, duration, description }) => (
              <div
                key={id}
                className="relative bg-[rgba(121,255,150,0.04)] border border-[#C3FFCD] border-opacity-5 rounded-[24px] px-8 py-8 flex flex-col items-center justify-center"
              >
                ...
                <p className="mt-2 text-white text-[24px] max-md:text-base max-sm:text-sm leading-[162.5%]">
                  {description}
                </p>
